...
export default function CfPerformanceOutcomePredictionForTicketSalesAnd() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-performance-outcome-prediction-for-ticket-sales-and-review/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-performance-outcome-prediction-for-ticket-sales-and-review', project: 'AITheaterPerformingArtsManager' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-performance-outcome-prediction-for-ticket-sales-and-review/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Performance outcome prediction for ticket sales and review sentiment</h1>
